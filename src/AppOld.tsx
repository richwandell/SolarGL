    ...
    function createProgram(gl: WebGL2RenderingContext): Program {
        ...
        return {
            ...
            uniformLocations: {
                ...
                lightPos: gl.getUniformLocation(shaderProgram, 'uLight') as WebGLUniformLocation
            },
        }
    }
    ...
    useEffect(() => {
        ...
        function run(time: number) {
            ...
            for (let i = 0; i < buffers.length; i++) {
                ...
                gl.uniformMatrix3fv(programInfo.uniformLocations.lightPos, false, [0.076245307922363, 5.903861999511719, 2.0054539442062378])
